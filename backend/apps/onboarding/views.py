...
def _nth_list_value(value, n):
    if isinstance(value, list):
        return str(value[n] or '').strip() if len(value) > n else ''
...
# (Distribution Channel, Division, Region, Tax1 category) -> Cust. Tax Classi.
# Sourced verbatim from ZBP_CUST.xlsx's JIN1-JIN6..CST-VAT sheet. Only
# defined for DC 10 and 20 with Division 10 - other DC/Division combos have
# no JIN1/JIN6 data in the source sheet and stay blank.
CUSTOMER_JIN_CLASSIFICATION_TABLE = {
    ('10', '10', 'AN', 'JIN1'): '',
    ('10', '10', 'AN', 'JIN6'): '',
    ('10', '10', 'AP', 'JIN1'): '',
    ('10', '10', 'AP', 'JIN6'): '',
...
def _customer_jin_classification(onboarding, tax_code):
    region = _sap_region_code(onboarding.state)
    key = (
        str(onboarding.distribution_channel or '').strip(),
        str(onboarding.division or '').strip(),
        region,
        tax_code,
    )
    return CUSTOMER_JIN_CLASSIFICATION_TABLE.get(key, '')
...
class CustomerExportView(APIView):
    ...
    COLUMNS = [
        ...
        ('Name3', lambda o: o.company_name_3),
        ('Name4', lambda o: o.company_name_4),
        ('Correspondence lang', lambda o: 'EN'),
        ('Search Term 1', lambda o: o.customer_search_term),
        ('Search Term 2', lambda o: o.pan_number),
        ('c/o Name Default Supplier', lambda o: ''),
        ('Street name (60)', lambda o: o.street1),
        ('Street4', lambda o: o.street4),
        ('Street5', lambda o: ''),
        ('Street2', lambda o: o.street2),
        ('Street3', lambda o: o.street3),
        ('House Number', lambda o: ''),
        ('District', lambda o: o.district),
        ('City postal code', lambda o: o.pincode),
        ('City', lambda o: o.city),
        ('Country', lambda o: 'IN' if str(o.country or '').strip().lower() in ['', 'india'] else o.country),
        ('Region', lambda o: _sap_region_code(o.state)),
        ('Transport Zone', lambda o: o.transportation_zone),
        ('PO_BOX', lambda o: ''),
        ('Postal code', lambda o: o.pincode),
        ('Telephone1', lambda o: ''),
        ('Telephone2', lambda o: ''),
        ('Telephone3', lambda o: ''),
        ('Mobile No1', lambda o: _first_list_value(o.phones)),
        ('Mobile No2', lambda o: _nth_list_value(o.phones, 1)),
        ('Mobile No3', lambda o: _nth_list_value(o.phones, 2)),
        ('Fax No.', lambda o: ''),
        ('E.mail1', lambda o: _first_list_value(o.emails)),
        ('E.mail12', lambda o: _nth_list_value(o.emails, 1)),
        ('E.mail13', lambda o: _nth_list_value(o.emails, 2)),
        ('Category', lambda o: ''),
        ('Customer GSTIN', lambda o: o.gst_number),
        ('Category', lambda o: ''),
        ('Customer TAN', lambda o: ''),
        ('PAN NO.', lambda o: o.pan_number),
        ('ID Type', lambda o: ''),
        ('ID Number', lambda o: ''),
        ('Vaild From', lambda o: ''),
        ('Valid To', lambda o: ''),
        ...
        ('Customer Bank IFSC', lambda o: o.ifsc_code),
        ('Customer Bank Account No', lambda o: str(o.account_number or '').strip()),
        ('Company Code', lambda o: o.customer_company_code),
        ('Recon Account', lambda o: o.gl_account_number),
        ('Sort Key', lambda o: ''),
        ('Planning group', lambda o: ''),
        ('Interest calculation indicator', lambda o: ''),
        ('Payment Term', lambda o: o.payment_terms),
        ...
        ('Sales Org', lambda o: _first_list_value(o.sales_organization)),
        ...
        ('Shipping Conditions', lambda o: '01'),
        ...
        # reference template. JIN1/JIN6 classification depends on
        # Distribution Channel + Division + Region (CUSTOMER_JIN_CLASSIFICATION_TABLE).
        ('Tax1 category', lambda o: 'JIN1'),
        ('Cust. Tax Classi.', lambda o: _customer_jin_classification(o, 'JIN1')),
        ('Tax1 category', lambda o: 'JIN6'),
        ('Cust. Tax Classi.', lambda o: _customer_jin_classification(o, 'JIN6')),
