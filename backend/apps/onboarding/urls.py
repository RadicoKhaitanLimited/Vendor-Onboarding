...
from .views import (
    ...
    OnboardingSingleExportView, CustomerExportView, PanDataExportView, BulkOnboardingImportView, BulkOnboardingTemplateView,
...
urlpatterns = [
    ...
    path('export/customers/', CustomerExportView.as_view(), name='customer_export'),
